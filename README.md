...
### Pre-trained model: [google drive](https://drive.google.com/file/d/1K3byGgLrnkBg6zL-yZ864ZLdABoMoZ5W/view?usp=share_link). unzip model to the root of the repository.
